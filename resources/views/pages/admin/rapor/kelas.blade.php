...
@section('title')
Data Rapor Kelas {{$kelas->nama_kelas}}
@endsection
      ...
      <div class="col-lg-12 col-md-6 col-12 col-sm-6">
        <div class="card">
          <div class="card-header">
            <h4>Data Rapor Kelas {{$kelas->nama_kelas}}</h4>
          </div>
          <div class="card-body">
            <table class="table table-striped table-hover" id="datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="/rapor/kelas/{{ $data->id_kelas }}/murid/{{ $data->id }}" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Input Rapor">
        ...
        <a href="{{ route('rapor.index') }}" class="btn btn-md btn-warning">Kembali</a>
      </div>
    </div>
  </section>
</div>
