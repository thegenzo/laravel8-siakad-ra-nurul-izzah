...
@section('title')
Data Nilai Kelas {{$kelas->nama_kelas}}
@endsection
      ...
      <div class="col-lg-12 col-md-6 col-12 col-sm-6">
        <div class="card">
          <div class="card-header">
            <h4>Data Nilai Kelas {{$kelas->nama_kelas}}</h4>
          </div>
          <div class="card-body">
            <table class="table table-striped table-hover" id="datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('nilai.murid', $data->id) }} " class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Input Nilai">
        ...
        <a href="{{ route('nilai.index') }}" class="btn btn-md btn-warning">Kembali</a>
      </div>
    </div>
  </section>
</div>
