  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item active">Pilih Kelas untuk Murid</div>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-12 col-md-6 col-12 col-sm-6">
            ...
            <table class="table table-striped table-hover" id="datatable">
                <thead>
                    <tr>
                        ...
                        <th>Alamat</th>
                        <th class="text-center">Pilih Kelas</th>
        ...
        <a href="{{ route('murid.index') }}" class="btn btn-md btn-warning">Kembali</a>
      </div>
    </div>
  </section>
</div>
