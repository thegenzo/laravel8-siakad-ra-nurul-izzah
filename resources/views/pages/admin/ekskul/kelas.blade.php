...
@section('title')
Data Ekskul Kelas {{$kelas->nama_kelas}}
@endsection
  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Data Ekskul</div>
      ...
      <div class="col-lg-12 col-md-6 col-12 col-sm-6">
        <div class="card">
          <div class="card-header">
            <h4>Data Ekskul Kelas {{$kelas->nama_kelas}}</h4>
          </div>
          <div class="card-body">
            <table class="table table-striped table-hover" id="datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('ekskul.murid', $data->id) }} " class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Input Ekskul">
        ...
        <a href="{{ route('ekskul.index') }}" class="btn btn-md btn-warning">Kembali</a>
      </div>
    </div>
  </section>
</div>
